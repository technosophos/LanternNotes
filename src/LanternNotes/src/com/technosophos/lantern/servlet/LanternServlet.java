package com.technosophos.lantern.servlet;
...
import com.technosophos.lantern.servlet.ServletConstants;
...
/**
 * Servlet implementation class for Servlet: LanternServlet
 * @web.servlet
 *   name="LanternNotes"
 *   display-name="LanternNotes" 
 *   description="Servlet for Lantern Web Interface"
 *   load-on-startup=1
 *
 * @web.servlet-mapping
 *   url-pattern="/Lantern" 
 ...
 */
 public class LanternServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	 ...
	 * from the GET/POST data that begin with _ will not be added to the parameter map, and thus
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		params.put(ServletConstants.REQ_PARAM_SESSION, new LanternSession(request.getSession(true)));
		...
		// FIXME: Character set is not enforced at all... if rc.getMimeType does not
		// return an encoding, none is set.
		//response.setCharacterEncoding("UTF-8");
		
		// Make sure content type is set before this line!
