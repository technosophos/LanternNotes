...
public class ServletConstants {
	...
	/** 
	 ...
	 /**
	  * The LanternSession object.
	  * @see com.technosophos.lantern.servlet.LanternSession.
	  */
	  ...
	  * The {@link LanternServlet} servlet inserts the base path information 
	  ...
	  * Set by {@link LanternServlet}. Retrieving the value from the context should
