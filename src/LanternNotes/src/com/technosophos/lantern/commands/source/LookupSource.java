...
import com.technosophos.lantern.sru.*;
import com.technosophos.lantern.types.SourceEnum;
import com.technosophos.lantern.xml.mods.*;
 ...
 *
 */
public class LookupSource extends LanternCommand {
	...
	protected void doLookup(String server, String index, String term) {
		...
		System.err.print(mods.toString());
