...
public class ModifyCourse extends AddCourse {
	/**
	...
	protected RhizomeDocument initializeDocument() {
		...
		try {
			...
			Metadatum cOn = doc.getMetadatum(CourseEnum.CREATED_ON.getKey());
			Metadatum cBy = doc.getMetadatum(CourseEnum.CREATED_BY.getKey());
