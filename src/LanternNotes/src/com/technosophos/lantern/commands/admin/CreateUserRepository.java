...
import com.technosophos.lantern.types.admin.UserEnum;
 ...
 * 
 * The machine ID for a repository should be its SHA1 value, I think. This will require extra
...
public class CreateUserRepository extends AbstractCommand {
	...
	public void execute() {
		 ...
		 * Note that we are looking for the USERNAME field from UserEnum, and then we
